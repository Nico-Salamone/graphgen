...
def compute_mdod(gen_graph_distr):
	...
	:return: The mean of deviations with results to the optimal distribution (MDOD). The value is between 0 and '2 / n',
		...
		(equal to 'len(gen_graph_distr)') is very high, the returned value will be very close to 0 and does not mean that
...
if __name__ == '__main__':
	...
	gen_graph_distr2 = {'g1': 12, 'g2': 8, 'g3': 11, 'g4': 9, 'g5': 12, 'g6': 10, 'g7': 8, 'g8': 10, 'g9': 11, 'g10': 9}
